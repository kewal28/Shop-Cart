...
//  Shop Cart
//
//  Created by Kewal Kanojia on 04/09/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions:
        ...
        navigationBarAppearace.tintColor = uicolorFromHex(rgbValue: 0x24c24e)
        navigationBarAppearace.barTintColor = uicolorFromHex(rgbValue: 0xffffff)
        navigationBarAppearace.titleTextAttributes = [NSForegroundColorAttributeName:uicolorFromHex(rgbValue: 0x24c24e)]
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Shop_Cart")
